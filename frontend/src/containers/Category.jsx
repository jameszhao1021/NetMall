...
function Category({ fetchProductsByCategory, products, searchQuery, setSearchQuery, searchResults, setSearchResults, handleSearchQueryChange }) {
  ...
  const handleSearch = async () => {
    try {
      const response = await axios.get(`/api/search/?category=${selectedCategory}&q=${searchQuery}`);
